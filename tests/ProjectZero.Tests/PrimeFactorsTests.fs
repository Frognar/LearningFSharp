...
let ``Factors of 10 should be [ 2; 5 ]`` () =
    Assert.Equivalent([ 2; 5 ], factorsOf 10)

[<Fact>]
let ``Factors of 11 should be [ 11 ]`` () =
    Assert.Equivalent([ 11 ], factorsOf 11)

[<Fact>]
let ``Factors of 2 * 2 * 3 * 3 * 5 * 5 * 7 * 7 * 11 * 11 should be [ 2; 2; 3; 3; 5; 5; 7; 7; 11; 11 ]`` () =
    Assert.Equivalent([ 2; 2; 3; 3; 5; 5; 7; 7; 11; 11 ], factorsOf (List.reduce (*) [ 2; 2; 3; 3; 5; 5; 7; 7; 11; 11 ]))
...
let ``Factors of 2^31 - 1 should be [ 2^31 - 1 ]`` () =
    Assert.Equivalent([ (intPow 2 31) - 1 ], factorsOf ((intPow 2 31) - 1))
